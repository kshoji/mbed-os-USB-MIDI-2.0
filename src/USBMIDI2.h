...
/**
 * \defgroup drivers_USBMIDI2 USBMIDI2 class
...
*            midi.write(MIDI2Message::NoteOn(i));
*            ThisThread::sleep_for(250);
*            midi.write(MIDI2Message::NoteOff(i));
...
* @endcode
*/
class USBMIDI2: public USBDevice {
public:
    ...
    */
    USBMIDI2(bool connect_blocking = true, uint16_t vendor_id = 0x0700, uint16_t product_id = 0x0101, uint16_t product_release = 0x0001);
    ...
    * @param product_release Your product_release
    */
    USBMIDI2(USBPhy *phy, uint16_t vendor_id, uint16_t product_id, uint16_t product_release);
     ...
     * Send a MIDI2Message
     *
     * @param m The MIDI2Message to send
     * @return true if the message was sent, false otherwise
     */
    bool write(MIDI2Message m);
     ...
     * Read a message
     *
     * @param m The MIDI2Message to fill
     * @return true if a message was read, false otherwise
     */
    bool read(MIDI2Message *m);
