...
#ifndef MIDI2MESSAGE_H
#define MIDI2MESSAGE_H
...
/**
 * \defgroup drivers_MIDI2Message MIDI2Message class
...
public:
    ...
    MIDI2Message() : data(new uint8_t[MAX_MIDI_MESSAGE_SIZE + 1]), length(0) {}

    MIDI2Message(uint8_t *buf) : data(new uint8_t[MAX_MIDI_MESSAGE_SIZE + 1]), length(0)
    {
        for (int i = 0; i < 4; i++) {
            data[i] = buf[i];
        }
     ...
     * Copy constructor
     */
    MIDI2Message(const MIDI2Message &other)
    {
        *this = other;
    }
     ...
     * Assignment operator
     */
    MIDI2Message &operator=(const MIDI2Message &other)
    {
        length = other.length;
    ...
    /**
     * Set this MIDI2Message to a raw MIDI message
     *
     ...
     * @returns A MIDI2Message
     */
    static MIDI2Message NoteOff(int key, int velocity = 127, int channel = 0)
    {
        MIDI2Message msg;
        msg.data[0] = CABLE_NUM | 0x20;
     ...
     * @returns A MIDI2Message
     */
    static MIDI2Message NoteOn(int key, int velocity = 127, int channel = 0)
    {
        MIDI2Message msg;
        msg.data[0] = CABLE_NUM | 0x20;
     ...
     * @returns A MIDI2Message
     */
    static MIDI2Message PolyphonicAftertouch(int key, int pressure, int channel = 0)
    {
        MIDI2Message msg;
        msg.data[0] = CABLE_NUM | 0x20;
     ...
     * @returns A MIDI2Message
     */
    static MIDI2Message ControlChange(int control, int value, int channel = 0)
    {
        MIDI2Message msg;
        msg.data[0] = CABLE_NUM | 0x20;
     ...
     * @returns A MIDI2Message
     */
    static MIDI2Message ProgramChange(int program, int channel = 0)
    {
        MIDI2Message msg;
        msg.data[0] = CABLE_NUM | 0x20;
     ...
     * @returns A MIDI2Message
     */
    static MIDI2Message ChannelAftertouch(int pressure, int channel = 0)
    {
        MIDI2Message msg;
        msg.data[0] = CABLE_NUM | 0x20;
     ...
     * @returns A MIDI2Message
     */
    static MIDI2Message PitchWheel(int pitch = 0, int channel = 0)
    {
        MIDI2Message msg;
     ...
     * @returns A MIDI2Message
     */
    static MIDI2Message AllNotesOff(int channel = 0)
    {
    ...
    * @returns A MIDI2Message
    */
    static MIDI2Message SysEx(uint8_t *data, int len)
    {
        MIDI2Message msg;
     ...
     *
     * @returns MIDI2MessageType
     */
    MIDI2MessageType type()
    {
        MIDI2MessageType message_type;
        uint8_t min_size;
        switch ((data[1] >> 4) & 0xF) {
            case 0x8:
                // message, channel
    ...
    int key()
    {
        MIDI2MessageType msg_type = type();
